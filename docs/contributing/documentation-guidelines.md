...
このドキュメントでは、VehicleVision.Pleasanter.CalendarHolidayStyleGenerator プロジェクトのドキュメント作成規約について説明します。
...
| 変更内容                     | 更新が必要なドキュメント                                   |
| ---------------------------- | ---------------------------------------------------------- |
| 利用者向け情報の変更         | `README.md`                                                |
| 開発者向け情報の変更         | `CONTRIBUTING.md`                                          |
